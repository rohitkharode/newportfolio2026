...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'rohitkharode1630@gmail.com',
    href: 'mailto:rohitkharode1630@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 93222 71210',
    // wa.me requires digits only — no +, no spaces, no hyphens
    href: 'https://wa.me/919322271210',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'rohit kharode',
    href: 'https://www.linkedin.com/in/rohit-kharode-72b6a32b2/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@rohitkharode',
    href: 'https://github.com/rohitkharode',
  },
];
      ...
      <FadeIn delay={0.4} y={20}>
        <div className="mx-auto mt-20 sm:mt-24 md:mt-28 flex max-w-5xl flex-col items-center gap-3 border-t border-[#D7E2EA]/10 pt-8 text-center sm:flex-row sm:justify-between">
          <span
            ...
            style={{ fontSize: 'clamp(0.7rem, 1.1vw, 0.9rem)' }}
          >
            © 2026 Rohit Kharode. All rights reserved.
          </span>
          <span
            className="font-light uppercase tracking-widest text-[#D7E2EA]/50"
            style={{ fontSize: 'clamp(0.7rem, 1.1vw, 0.9rem)' }}
          >
           devloped with love by Rohit Kharode
          </span>
        </div>
      </FadeIn>
    </section>
