...
const SERVICES = [
  ...
  },
  {
    ...
    description:
      'Wiring large language models into real products via Gemini, Claude, and OpenAI APIs  .',
  },
  {
    number: '04',
  ...
  },
  {
    ...
    description:
      'Exploring datasets with Python  and R  turning raw numbers into clear insights and dashboards stakeholders can act on.',
  },
];
